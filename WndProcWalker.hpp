//    WndProcWalker
//    Copyright (c) 2026 Berkay Yigit <mail@berkay.link>
//    Copyright (c) 2026 Lovro Pleše (Xan/Tenjoin)
// 
...
#ifndef WNDPROCWALKER_HPP
#define WNDPROCWALKER_HPP
...
namespace WndProcWalker {
    ...
    inline HWND GetWindowHandle() {
        return details::sWindowHandle;
    }
    inline bool IsWindowActive() {
        return details::sIsWindowActive;
    }
    inline void AddWndProc(WNDPROC fn) {
        details::sWndProc.second.push_back(fn);
    }

    inline void Init(HWND hWnd) {

        details::sWindowHandle = hWnd;
